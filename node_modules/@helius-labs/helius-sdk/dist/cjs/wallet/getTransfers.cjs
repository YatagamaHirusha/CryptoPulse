 ...
 * ```
 */
const getTransfers = async (apiKey, params, userAgent) => {
    ...
    const url = `${utils.BASE_URL}/${wallet}/transfers${utils.buildQueryString(queryParams)}`;
    const response = await fetch(url, {
        method: "GET",
        headers: utils.getHeaders(false, userAgent),
    });
    return utils.handleResponse(response);
};

exports.getTransfers = getTransfers;
//# sourceMappingURL=getTransfers.cjs.map
