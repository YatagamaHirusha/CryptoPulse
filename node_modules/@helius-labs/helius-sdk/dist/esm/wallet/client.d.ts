import type { GetIdentityRequest, GetIdentityResponse, GetBatchIdentityRequest, GetBatchIdentityResponse, GetBalancesRequest, GetBalancesResponse, GetHistoryRequest, GetHistoryResponse, GetTransfersRequest, GetTransfersResponse, GetFundedByRequest, GetFundedByResponse } from "./types";
/**
...
export interface WalletClient {
     ...
     */
    getBatchIdentity(params: GetBatchIdentityRequest): Promise<GetBatchIdentityResponse>;
    /**
 ...
 * ```
 */
export declare const makeWalletClient: (apiKey: string, userAgent?: string) => WalletClient;
