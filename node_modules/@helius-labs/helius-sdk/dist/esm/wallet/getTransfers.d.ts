 ...
 * ```
 */
export declare const getTransfers: (apiKey: string, params: GetTransfersRequest, userAgent?: string) => Promise<GetTransfersResponse>;
//# sourceMappingURL=getTransfers.d.ts.map